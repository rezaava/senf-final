        ...
        <div class="row g-0 mt-4 p-3 rounded-4 shadow bg-white pb-3">
            <div class="clearfix mt-2">
                <div class="d-flex justify-content-between align-items-center mt-2 mb-3">
                    <h5 class="float-end">ویرایش خدمت</h5>
                    <a href="/dashboard/services" class="btn btn-outline-danger">انصراف</a>
                </div>
            </div>
            <form action="{{ route('service.update', $service->id) }}" class="px-4 mt-4" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="price_max" placeholder="سقف قیمت خدمت"
                                name="price_max" value="{{ old('price_max') }}">
                            @error('price_max')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="off" placeholder="مقدار تخفیف"
                                name="off" value="{{ old('off', $service->off) }}">
                            @error('off')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($service->image)
                        <div class="mt-2">
                            <img src="{{ asset($service->image) }}" alt="عکس خدمت" width="100">
                        </div>
                    @endif
                    @error('image')
                        <small class="text-danger">{{ $message }}</small>
                ...
                <div class="d-flex justify-content-center mt-4">
                    <button type="submit"
                        class="btn submit-btn w-25 border border-3 border-dark align-middle rounded-pill shadow">ویرایش</button>
                </div>
            </form>
        </div>
    </div>
